# -*- coding: UTF-8 -*-
# filename: TestAllDataset date: 2019/4/8 20:02  
# author: FD 
import torch
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', choices=models.available_models, default='signet',
                        help='Model architecture', dest='model')
    parser.add_argument('--model-path', default='./data/models/model_best.pth')
    parser.add_argument('--data-path', default='./testdata/dataset/sig_exp_dataset_fused.npz')
    parser.add_argument('--save-path', default='./testdata/results/result.npz')
