...
def main():
    ...
    pickle.dump(results, open('train_size_result.pkl', 'wb'))
    # pass
...
def show_evaluation_plot():
    ...
    # plt.plot(x, results[:, 0], lw=2, marker='o', markersize=12)
    ...
    # plt.yticks(fontsize=20, fontname='normal')
    # plt.tight_layout()
    # plt.savefig('./train_size_eer.pdf')
    # plt.show()
    plt.figure(figsize=(10, 6))
    ...
    plt.tight_layout()
    plt.savefig('./train_size_auc_eer.pdf')
    plt.show()
